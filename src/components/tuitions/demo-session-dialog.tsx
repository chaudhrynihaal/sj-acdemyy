...
export function DemoSessionDialog({ open, onClose }: DemoSessionDialogProps) {
    ...
    try {
      ...
      const msg =
        e instanceof Error && e.message
          ? e.message
          : "Could not submit. Please email admissions@sjacademy.com.";
      setError(msg);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-slate-100 bg-white p-6 shadow-2xl">
        ...
        <h2 className="text-xl font-bold text-navy">Free demo session</h2>
        <p className="mt-1 text-sm text-slate-600">
          Tell us a little about the learner and we will arrange a suitable slot.
        </p>
        {done ? (
