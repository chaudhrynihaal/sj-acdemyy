  ...
  return (
    <section className="bg-navy py-20 text-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-16">
        <FadeInUp>
          <div className="mb-12">
            ...
            <p className="mt-3 text-base text-slate-300">
              Real stories of transformation and success from our dedicated
              students.
            </p>
          </div>
        </FadeInUp>
        ...
        {list.length > 2 && (
          <div className="mt-6 flex gap-6 overflow-x-auto pb-4 pt-2 [scrollbar-width:thin] md:hidden">
            {list.slice(2).map((t) => (
              <div key={t.id} className="min-w-[280px] max-w-sm shrink-0">
                <TestimonialCard t={t} />
              </div>
            ))}
          </div>
